...
const questionsList = questions(getConfig);
const question = initQuestion(getConfig);
...
if (argv.v) {
  ...
  typeof getConfig['initial-commit'] === 'object' &&
  getConfig['initial-commit'].isEnabled) {
  const message = initMessage(getConfig);
